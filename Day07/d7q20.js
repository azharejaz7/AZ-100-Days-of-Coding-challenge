...
var countries = ["japan", "indonesia", "Canada", "Brazil", "kuwait"];
var mountains = ["Mount Everest", "K2 Pkaistan"];
var languages = ["Urdu", "Japness", "Chiness", "English"];
var cities = ["Karachi", "islamabad", "New York",];
console.log("".concat(countries));
console.log("".concat(mountains));
console.log("".concat(languages));
console.log("".concat(cities));
